...
public class SearchPageStep {
    ...
    @When("User clear all post a job under jobs draft section")
    public void user_clear_all_post_a_job_under_jobs_draft_section() {
        searchPage.clearAllPostAJobs();
    }

    @When("User create post a job for Client user")
    public void user_create_post_a_job_for_client_user() {
        searchPage.userCreatePostAJob();
    }

    @Then("validate Post a job test for all gadget")
    public void validate_post_job_test_for_all_gadget() {
        searchPage.validatePostAJob();
    }
